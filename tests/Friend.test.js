...
test('Класс Friend должен возвращать корректный возраст, когда ДР еще не было в этом году', () => {
    mockDate(2026, 5, 15); // 15 мая 2026
    
    const friend1 = new Friend('Иван Иванов', '1990-05-15');
    const friend2 = new Friend('Марина Петрова', '1985-10-20');
    const friend3 = new Friend('Альберт Блэк', '2000-12-25');
    
    expect(friend1.getAge()).toBe(36); // 2026 - 1990
    expect(friend2.getAge()).toBe(40); // 2026 - 1985 - 1 (день рождения еще не наступил)
    expect(friend3.getAge()).toBe(25); // 2026 - 2000 - 1
});